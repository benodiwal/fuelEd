...
export default class EventsRouter extends AbstractRouter {
  ...
  registerRoutes(): void {
    ...
    this.registerPOST('/:id/host-message', eventsController.createHostMessage());
    this.registerPUT('/:id/host-message', eventsController.updateHostMessage());
    ...
    this.registerPOST('/:id/venue-plan', eventsController.createVenuePlan());
